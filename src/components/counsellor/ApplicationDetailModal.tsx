  ...
  const handleApprove = async () => {
    try {
      ...
      const { error } = await supabase
        .from("applications")
        .update({
          counsellor_verified: true,
          counsellor_verified_at: new Date().toISOString(),
          status: "counsellor_verified",
        })
              ...
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="flex items-start gap-3 bg-purple-50 dark:bg-purple-950 p-3 rounded-lg">
                      <div className="h-5 w-5 rounded-full bg-purple-500 mt-0.5" />
                      <div>
      ...
      <AlertDialog open={showApproveDialog} onOpenChange={setShowApproveDialog}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              Are you sure you want to approve this application? It will be sent to the Class
              Advisor for further review.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
